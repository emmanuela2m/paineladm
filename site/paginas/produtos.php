        ...
        <!--Navegaçãp-->
        <div class="container mt-3"><div class="card-columns">
                <div class="card">
                    <img class="card-img-top" src="https://placehold.it/253x160/" alt="Imagem de capa do card">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img" src="https://placehold.it/253x160/" alt="Imagem do card">
                </div>
